...
/*
 * Mini-exercise: fix TODO's to make it work
 */
...
myobject_getbuffer(PyObject *obj, Py_buffer *view, int flags)
{
    ...
    TODO: Fill in view->shape[0] and 1, view->strides[0] and 1, view->len,
    and view->ndim, and view->itemsize so that the result is a (2, 2) array
