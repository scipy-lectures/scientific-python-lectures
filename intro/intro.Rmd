...
{ref}`chapters on advanced topics <advanced-topics-part>`

{ref}`chapters on packages and applications <applications-part>`
:::
...
:::{seealso}
{ref}`Chapter on optimizing code <optimizing_code_chapter>`
:::
...
:::{seealso}
{ref}`Chapter on debugging <debugging_chapter>`
:::
