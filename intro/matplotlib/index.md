...
affect (see [Line properties] and [Line styles] below).
:::
...
Finally, there is a [user mailing list](https://mail.python.org/mailman/listinfo/matplotlib-users) where you can
ask for help and a [developers mailing list](https://mail.python.org/mailman/listinfo/matplotlib-devel) that is more
technical.
