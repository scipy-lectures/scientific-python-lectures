...
[^mallet]: Mallet, C. and Bretar, F. Full-Waveform Topographic Lidar:
  State-of-the-Art. *ISPRS Journal of Photogrammetry and Remote Sensing*
...
*Remark:* in fact, you should rather use {func}`scipy.optimize.curve_fit`
...
[^data]: The data used for this tutorial are part of the demonstration data
