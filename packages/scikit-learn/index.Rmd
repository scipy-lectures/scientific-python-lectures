...
:::{admonition} Exercise: Gradient Boosting Tree Regression
:class: green
...
:::{admonition} Exercise: Other dimension reduction of digits
:class: green
...
:::{admonition} Polynomial regression with scikit-learn
