...
component analysis ([PCA](httsp://en.wikipedia.org/wiki/Principal_component_analysis)) and
...
for efficient numerical computation](https://hal.inria.fr/inria-00564007/en)
...
- **Use compiled code**
  ...
  [Cython](https://www.cython.org): it is easy to transform exiting
...
- If you need to profile memory usage, you could try the [memory_profiler](https://pypi.org/project/memory-profiler)
...
- If you need some interactive visualization why not try [RunSnakeRun](https://www.vrplumber.com/programming/runsnakerun/)
